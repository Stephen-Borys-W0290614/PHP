...
require_once '../model/data/iFilmDataModel.php'; //interface file must be included
class PDOMySQLFilmsDataModel implements iFilmDataModel
{
    ...
    public function fetchMovieName($row){
        //extract the specific film name from the appropriate
        //column with the current row of film data you are focused on
        return $row['title'];
    ...
    public function fetchMovieDescription($row){
        //extract the specific film description from the appropriate
        //column with the current row of film data you are focused on
